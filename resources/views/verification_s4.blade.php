...
@section('title', 'Verification > Server4 ')
        ...
        <div class="card">
            <div class="card-body">
                <div class="general-label">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('verification_server4') }}">
                        @csrf
...
@section('before-scripts')
    ...
    <script>
        @if($response ?? '')
            swal({
                title: "{{$status}}",
                type: @if($status=="completed") "success" @else "error" @endif,
                html: '{{$description}}',
                showCloseButton: @if($status=="completed") !0 @else 0 @endif,
                showCancelButton: @if($status!="completed") !0 @else 0 @endif,
