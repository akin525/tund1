                        ...
                        <div class="ibox-content">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                <div class="col-lg-12">
                                    ...
                                    <form method="POST" action="{{ route('addfund') }}">
                                        @csrf
                                    <div class="form-group">
                                        ...
                                        <div align="center" class="col-sm-10 col-lg-12">
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">Payment Channel</label>

                                                <div class="col-sm-10"><select class="form-control m-b" name="payment_channel">
