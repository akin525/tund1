        ...
        <div class="card">
            <div class="card-body">
                <div class="general-label">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('adddatatransaction') }}">
                        @csrf
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group mt-2">
                                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-shopping-cart"></i> </span></div>
                                    <input type="text" name="plan" placeholder="Enter Plan" class="form-control input-lg m-b">
                                </div>

                                <div class="input-group mt-2">
                                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-mobile"></i> </span></div>
                                    <input type="tel" name="phoneno" placeholder="Enter Phone no" class="form-control input-lg m-b">
                                </div>
